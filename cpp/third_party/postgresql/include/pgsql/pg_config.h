...
#define CONFIGURE_ARGS " '--build=x86_64-alt-linux' '--host=x86_64-alt-linux' '--prefix=/usr' '--exec-prefix=/usr' '--bindir=/usr/bin' '--sbindir=/usr/sbin' '--sysconfdir=/etc' '--datadir=/usr/share' '--includedir=/usr/include' '--libdir=/usr/lib64' '--libexecdir=/usr/lib' '--localstatedir=/var/lib' '--sharedstatedir=/var/lib' '--mandir=/usr/share/man' '--infodir=/usr/share/info' '--disable-dependency-tracking' '--disable-silent-rules' '--without-included-gettext' '--includedir=/usr/include/pgsql' '--sysconfdir=/etc/pgsql' '--datadir=/usr/share/pgsql' '--disable-rpath' '--enable-nls' '--enable-thread-safety' '--with-icu' '--with-llvm' '--with-docdir=/usr/share/doc/postgresql-15.13' '--with-includes=/usr/include/krb5' '--with-pam' '--with-openssl' '--with-perl' '--with-gssapi' '--with-krb5' '--with-ldap' '--with-tcl' '--with-tclconfig=/usr/lib64' '--with-readline' '--with-python' '--with-libxml' '--with-selinux' '--with-libxslt' '--with-gnu-ld' '--with-ossp-uuid' '--with-lz4' '--with-zstd' 'build_alias=x86_64-alt-linux' 'host_alias=x86_64-alt-linux' 'CC=gcc' 'CFLAGS=-pipe -frecord-gcc-switches -Wall -g -O2 -flto=auto -ffat-lto-objects' 'CXX=g++' 'CXXFLAGS=-pipe -frecord-gcc-switches -Wall -g -O2 -flto=auto -ffat-lto-objects' 'LLVM_CONFIG=/usr/bin/llvm-config-19' 'CLANG=/usr/bin/clang-19'"
...
#define PG_VERSION "15.13"

/* PostgreSQL version as a number */
#define PG_VERSION_NUM 150013

/* A string containing the version number, platform, and C compiler */
#define PG_VERSION_STR "PostgreSQL 15.13 on x86_64-alt-linux-gnu, compiled by x86_64-alt-linux-gcc (GCC) 13.2.1 20240128 (ALT Sisyphus 13.2.1-alt3), 64-bit"
